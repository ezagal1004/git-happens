...
export default function Terminal({ prompt, choices, correctCommand, onCommand, onError }) {
  ...
  return (
    <div className="bg-card rounded-lg border overflow-hidden shadow-sm">
      ...
      <div 
        ref={terminalRef}
        className="bg-slate-950 text-slate-100 p-4 font-mono text-sm cursor-text min-h-[300px]"
        onClick={handleTerminalClick}
      >
        {/* Prompt text */}
        <div className="text-emerald-400 mb-4 leading-relaxed">
          {prompt}
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="bg-transparent text-slate-100 outline-none w-full caret-transparent pl-1"
              placeholder=""
              autoComplete="off"
              spellCheck="false"
            />
        ...
        {/* Typing indicator */}
        {isTyping && (
          <div className="text-amber-400 mb-4 flex items-center">
